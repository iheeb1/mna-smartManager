...
import { QuoteItem } from '../quote-items/quote-item.entity';

@Entity('mng_quotes')
@Index('FKIndex', ['customerId', 'driverId', 'orderTypeId', 'orderStatusId', 'shippingCertificateId', 'fromLocationId', 'toLocationId', 'orderDate', 'conversionDate'])
export class Quote {
