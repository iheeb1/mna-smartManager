...
@Entity('mng_customers')
@Unique('CustomerId_UNIQUE', ['customerId'])
...
export class Customer {
  ...
  @Column({ name: 'CustomerParentId', type: 'int', default: 0, nullable: true })
  ...
  @Column({ name: 'CustomerAllowedExcessAmount', type: 'decimal', precision: 20, scale: 2, nullable: true })
  customerAllowedExcessAmount: number;

  @Column({ name: 'CustomerAllowedExcessDays', type: 'int', nullable: true })
